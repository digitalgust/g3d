...
public class GeometryLoader {
    ...
    List<org.mini.g3d.core.collada.AnimatedVertex> vertices = new ArrayList<org.mini.g3d.core.collada.AnimatedVertex>();
    ...
    private void readPositions() {
        ...
        for (int i = 0; i < count / 3; i++) {
            ...
            vertices.add(new org.mini.g3d.core.collada.AnimatedVertex(vertices.size(), new Vector3f(position.x, position.y, position.z), vertexWeights.get(vertices.size())));
        }
    }
    ...
    private org.mini.g3d.core.collada.AnimatedVertex processVertex(int posIndex, int normIndex, int texIndex) {
        org.mini.g3d.core.collada.AnimatedVertex currentVertex = vertices.get(posIndex);
    ...
    private float convertDataToArrays() {
        ...
        for (int i = 0; i < vertices.size(); i++) {
            org.mini.g3d.core.collada.AnimatedVertex currentVertex = vertices.get(i);
    ...
    private org.mini.g3d.core.collada.AnimatedVertex dealWithAlreadyProcessedVertex(org.mini.g3d.core.collada.AnimatedVertex previousVertex, int newTextureIndex, int newNormalIndex) {
        if (previousVertex.hasSameTextureAndNormal(newTextureIndex, newNormalIndex)) {
            indices.add(previousVertex.getIndex());
            return previousVertex;
        } else {
            org.mini.g3d.core.collada.AnimatedVertex anotherVertex = (org.mini.g3d.core.collada.AnimatedVertex) previousVertex.getDuplicateVertex();
            if (anotherVertex != null) {
                return dealWithAlreadyProcessedVertex(anotherVertex, newTextureIndex, newNormalIndex);
            } else {
                org.mini.g3d.core.collada.AnimatedVertex duplicateVertex = new org.mini.g3d.core.collada.AnimatedVertex(vertices.size(), previousVertex.getPosition(), previousVertex.getWeightsData());
    ...
    private void removeUnusedVertices() {
        for (org.mini.g3d.core.collada.AnimatedVertex vertex : vertices) {
