...
public class SimplePanel extends GOpenGLPanel {
    ...
    public void gl_init() {
        ...
        int[] whd = {0, 0, 0};
        texture1[0] = gl_image_load(GToolkit.readFileFromJar("/res/textures/fern.png"), whd);

        texture2[0] = gl_image_load(GToolkit.readFileFromJar("/res/textures/pine.png"), whd);
