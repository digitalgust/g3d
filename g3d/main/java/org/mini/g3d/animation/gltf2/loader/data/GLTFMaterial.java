...
public class GLTFMaterial extends GLTFChildOfRootProperty {
    ...
    public void setAlphaMode(String alphaMode) {
        this.alphaMode = GLTFAlphaMode.valueOf(alphaMode);
    }
    ...
    public void setPbrMetallicRoughness(GLTFPBRMetallicRoughness pbrMetallicRoughness) {
    ...
    public void setDoubleSided(boolean b) {
        doubleSided = b;
    }
